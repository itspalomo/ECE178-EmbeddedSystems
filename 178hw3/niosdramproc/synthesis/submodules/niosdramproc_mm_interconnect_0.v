...
module niosdramproc_mm_interconnect_0 (
	...
	wire   [23:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> uart_avalon_rs232_slave_agent:cp_channel
	...
	wire   [23:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> SYSID_control_slave_agent:cp_channel
	...
	wire   [23:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> joseproc3_jtag_debug_module_agent:cp_channel
	...
	wire   [23:0] cmd_mux_004_src_channel;                                                         // cmd_mux_004:src_channel -> LEDG_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> switches_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_008_src_channel;                                                         // cmd_mux_008:src_channel -> sys_clock_timer_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_009_src_channel;                                                         // cmd_mux_009:src_channel -> Push_buttons_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_010_src_channel;                                                         // cmd_mux_010:src_channel -> Hex_4_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_011_src_channel;                                                         // cmd_mux_011:src_channel -> Hex_5_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_012_src_channel;                                                         // cmd_mux_012:src_channel -> Hex_6_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_013_src_channel;                                                         // cmd_mux_013:src_channel -> Hex_7_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_014_src_channel;                                                         // cmd_mux_014:src_channel -> Hex_1_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_015_src_channel;                                                         // cmd_mux_015:src_channel -> Hex_2_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_016_src_channel;                                                         // cmd_mux_016:src_channel -> Hex_3_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_017_src_channel;                                                         // cmd_mux_017:src_channel -> Hex_0_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_018_src_channel;                                                         // cmd_mux_018:src_channel -> LEDR_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_019_src_channel;                                                         // cmd_mux_019:src_channel -> mot_0_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_020_src_channel;                                                         // cmd_mux_020:src_channel -> mot_1_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_021_src_channel;                                                         // cmd_mux_021:src_channel -> hctrig_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_022_src_channel;                                                         // cmd_mux_022:src_channel -> hcecho_s1_agent:cp_channel
	...
	wire   [23:0] cmd_mux_023_src_channel;                                                         // cmd_mux_023:src_channel -> buzzer_s1_agent:cp_channel
	...
	wire   [23:0] router_src_channel;                                                              // router:src_channel -> joseproc3_data_master_limiter:cmd_sink_channel
	...
	wire   [23:0] joseproc3_data_master_limiter_cmd_src_channel;                                   // joseproc3_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [23:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> joseproc3_data_master_limiter:rsp_sink_channel
	...
	wire   [23:0] joseproc3_data_master_limiter_rsp_src_channel;                                   // joseproc3_data_master_limiter:rsp_src_channel -> joseproc3_data_master_agent:rp_channel
	...
	wire   [23:0] router_001_src_channel;                                                          // router_001:src_channel -> joseproc3_instruction_master_limiter:cmd_sink_channel
	...
	wire   [23:0] joseproc3_instruction_master_limiter_cmd_src_channel;                            // joseproc3_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [23:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> joseproc3_instruction_master_limiter:rsp_sink_channel
	...
	wire   [23:0] joseproc3_instruction_master_limiter_rsp_src_channel;                            // joseproc3_instruction_master_limiter:rsp_src_channel -> joseproc3_instruction_master_agent:rp_channel
	...
	wire   [23:0] cmd_demux_001_src1_channel;                                                      // cmd_demux_001:src1_channel -> cmd_mux_006:sink1_channel
	...
	wire   [23:0] cmd_demux_001_src2_channel;                                                      // cmd_demux_001:src2_channel -> cmd_mux_007:sink1_channel
	...
	wire   [23:0] rsp_demux_006_src1_channel;                                                      // rsp_demux_006:src1_channel -> rsp_mux_001:sink1_channel
	...
	wire   [23:0] rsp_demux_007_src1_channel;                                                      // rsp_demux_007:src1_channel -> rsp_mux_001:sink2_channel
	...
	wire   [23:0] joseproc3_data_master_limiter_cmd_valid_data;                                    // joseproc3_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [23:0] joseproc3_instruction_master_limiter_cmd_valid_data;                             // joseproc3_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
