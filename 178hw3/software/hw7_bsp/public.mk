...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../niosdramproc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is niosdramproc
SOPC_NAME := niosdramproc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2170
SOPC_SYSID_FLAG += --sidp=0x2170
ELF_PATCH_FLAG  += --sidp 0x2170

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1652665328
SOPC_SYSID_FLAG += --timestamp=1652665328
ELF_PATCH_FLAG  += --timestamp 1652665328
