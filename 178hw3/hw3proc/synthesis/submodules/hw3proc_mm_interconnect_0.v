...
module hw3proc_mm_interconnect_0 (
	...
	wire   [18:0] cmd_mux_003_src_channel;                                                       // cmd_mux_003:src_channel -> hw3proc_jtag_debug_module_agent:cp_channel
	...
	wire   [18:0] cmd_mux_005_src_channel;                                                       // cmd_mux_005:src_channel -> switches_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_006_src_channel;                                                       // cmd_mux_006:src_channel -> ledr_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_007_src_channel;                                                       // cmd_mux_007:src_channel -> ledg_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_008_src_channel;                                                       // cmd_mux_008:src_channel -> hex_0_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_009_src_channel;                                                       // cmd_mux_009:src_channel -> hex_1_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_010_src_channel;                                                       // cmd_mux_010:src_channel -> hex_2_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_011_src_channel;                                                       // cmd_mux_011:src_channel -> hex_3_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_012_src_channel;                                                       // cmd_mux_012:src_channel -> hex_4_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_013_src_channel;                                                       // cmd_mux_013:src_channel -> hex_5_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_014_src_channel;                                                       // cmd_mux_014:src_channel -> hex_6_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_015_src_channel;                                                       // cmd_mux_015:src_channel -> hex_7_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_016_src_channel;                                                       // cmd_mux_016:src_channel -> system_timer_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_017_src_channel;                                                       // cmd_mux_017:src_channel -> hr_timer_s1_agent:cp_channel
	...
	wire   [22:0] pushbuttons_s1_agent_m0_address;                                               // pushbuttons_s1_agent:m0_address -> pushbuttons_s1_translator:uav_address
	...
	wire  [103:0] pushbuttons_s1_agent_rf_source_data;                                           // pushbuttons_s1_agent:rf_source_data -> pushbuttons_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] pushbuttons_s1_agent_rsp_fifo_out_data;                                        // pushbuttons_s1_agent_rsp_fifo:out_data -> pushbuttons_s1_agent:rf_sink_data
	...
	wire          cmd_mux_018_src_valid;                                                         // cmd_mux_018:src_valid -> pushbuttons_s1_agent:cp_valid
	wire  [102:0] cmd_mux_018_src_data;                                                          // cmd_mux_018:src_data -> pushbuttons_s1_agent:cp_data
	wire          cmd_mux_018_src_ready;                                                         // pushbuttons_s1_agent:cp_ready -> cmd_mux_018:src_ready
	wire   [18:0] cmd_mux_018_src_channel;                                                       // cmd_mux_018:src_channel -> pushbuttons_s1_agent:cp_channel
	wire          cmd_mux_018_src_startofpacket;                                                 // cmd_mux_018:src_startofpacket -> pushbuttons_s1_agent:cp_startofpacket
	wire          cmd_mux_018_src_endofpacket;                                                   // cmd_mux_018:src_endofpacket -> pushbuttons_s1_agent:cp_endofpacket
	...
	wire  [102:0] pushbuttons_s1_agent_rp_data;                                                  // pushbuttons_s1_agent:rp_data -> router_020:sink_data
	...
	wire  [102:0] router_020_src_data;                                                           // router_020:src_data -> rsp_demux_018:sink_data
	...
	wire   [18:0] router_src_channel;                                                            // router:src_channel -> hw3proc_data_master_limiter:cmd_sink_channel
	...
	wire   [18:0] hw3proc_data_master_limiter_cmd_src_channel;                                   // hw3proc_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [18:0] rsp_mux_src_channel;                                                           // rsp_mux:src_channel -> hw3proc_data_master_limiter:rsp_sink_channel
	...
	wire   [18:0] hw3proc_data_master_limiter_rsp_src_channel;                                   // hw3proc_data_master_limiter:rsp_src_channel -> hw3proc_data_master_agent:rp_channel
	...
	wire   [18:0] router_001_src_channel;                                                        // router_001:src_channel -> hw3proc_instruction_master_limiter:cmd_sink_channel
	...
	wire   [18:0] hw3proc_instruction_master_limiter_cmd_src_channel;                            // hw3proc_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [18:0] rsp_mux_001_src_channel;                                                       // rsp_mux_001:src_channel -> hw3proc_instruction_master_limiter:rsp_sink_channel
	...
	wire   [18:0] hw3proc_instruction_master_limiter_rsp_src_channel;                            // hw3proc_instruction_master_limiter:rsp_src_channel -> hw3proc_instruction_master_agent:rp_channel
	...
	wire  [102:0] cmd_demux_src18_data;                                                          // cmd_demux:src18_data -> cmd_mux_018:sink0_data
	...
	wire  [102:0] rsp_demux_018_src0_data;                                                       // rsp_demux_018:src0_data -> rsp_mux:sink18_data
	...
	wire   [18:0] router_003_src_channel;                                                        // router_003:src_channel -> sram_0_avalon_sram_slave_rsp_width_adapter:in_channel
	...
	wire   [18:0] sram_0_avalon_sram_slave_rsp_width_adapter_src_channel;                        // sram_0_avalon_sram_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire   [18:0] cmd_mux_001_src_channel;                                                       // cmd_mux_001:src_channel -> sram_0_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire   [18:0] hw3proc_data_master_limiter_cmd_valid_data;                                    // hw3proc_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [18:0] hw3proc_instruction_master_limiter_cmd_valid_data;                             // hw3proc_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	hw3proc_mm_interconnect_0_router_002 router_020 (
	...
	hw3proc_mm_interconnect_0_cmd_mux cmd_mux_018 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (hw3proc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hw3proc_mm_interconnect_0_rsp_demux rsp_demux_018 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (hw3proc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
