...
`timescale 1 ps / 1 ps
module joseproc_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                //                              clk_0_clk.clk
		input  wire        JoseProc_reset_n_reset_bridge_in_reset_reset, // JoseProc_reset_n_reset_bridge_in_reset.reset
		input  wire [13:0] JoseProc_data_master_address,                 //                   JoseProc_data_master.address
		output wire        JoseProc_data_master_waitrequest,             //                                       .waitrequest
		input  wire [3:0]  JoseProc_data_master_byteenable,              //                                       .byteenable
		input  wire        JoseProc_data_master_read,                    //                                       .read
		output wire [31:0] JoseProc_data_master_readdata,                //                                       .readdata
		input  wire        JoseProc_data_master_write,                   //                                       .write
		input  wire [31:0] JoseProc_data_master_writedata,               //                                       .writedata
		input  wire        JoseProc_data_master_debugaccess,             //                                       .debugaccess
		input  wire [12:0] JoseProc_instruction_master_address,          //            JoseProc_instruction_master.address
		output wire        JoseProc_instruction_master_waitrequest,      //                                       .waitrequest
		input  wire        JoseProc_instruction_master_read,             //                                       .read
		output wire [31:0] JoseProc_instruction_master_readdata,         //                                       .readdata
		...
		output wire [8:0]  JoseProc_jtag_debug_module_address,           //             JoseProc_jtag_debug_module.address
		output wire        JoseProc_jtag_debug_module_write,             //                                       .write
		output wire        JoseProc_jtag_debug_module_read,              //                                       .read
		input  wire [31:0] JoseProc_jtag_debug_module_readdata,          //                                       .readdata
		output wire [31:0] JoseProc_jtag_debug_module_writedata,         //                                       .writedata
		output wire [3:0]  JoseProc_jtag_debug_module_byteenable,        //                                       .byteenable
		input  wire        JoseProc_jtag_debug_module_waitrequest,       //                                       .waitrequest
		output wire        JoseProc_jtag_debug_module_debugaccess,       //                                       .debugaccess
	...
	wire         joseproc_data_master_translator_avalon_universal_master_0_waitrequest;          // JoseProc_data_master_agent:av_waitrequest -> JoseProc_data_master_translator:uav_waitrequest
	wire  [31:0] joseproc_data_master_translator_avalon_universal_master_0_readdata;             // JoseProc_data_master_agent:av_readdata -> JoseProc_data_master_translator:uav_readdata
	wire         joseproc_data_master_translator_avalon_universal_master_0_debugaccess;          // JoseProc_data_master_translator:uav_debugaccess -> JoseProc_data_master_agent:av_debugaccess
	wire  [13:0] joseproc_data_master_translator_avalon_universal_master_0_address;              // JoseProc_data_master_translator:uav_address -> JoseProc_data_master_agent:av_address
	wire         joseproc_data_master_translator_avalon_universal_master_0_read;                 // JoseProc_data_master_translator:uav_read -> JoseProc_data_master_agent:av_read
	wire   [3:0] joseproc_data_master_translator_avalon_universal_master_0_byteenable;           // JoseProc_data_master_translator:uav_byteenable -> JoseProc_data_master_agent:av_byteenable
	wire         joseproc_data_master_translator_avalon_universal_master_0_readdatavalid;        // JoseProc_data_master_agent:av_readdatavalid -> JoseProc_data_master_translator:uav_readdatavalid
	wire         joseproc_data_master_translator_avalon_universal_master_0_lock;                 // JoseProc_data_master_translator:uav_lock -> JoseProc_data_master_agent:av_lock
	wire         joseproc_data_master_translator_avalon_universal_master_0_write;                // JoseProc_data_master_translator:uav_write -> JoseProc_data_master_agent:av_write
	wire  [31:0] joseproc_data_master_translator_avalon_universal_master_0_writedata;            // JoseProc_data_master_translator:uav_writedata -> JoseProc_data_master_agent:av_writedata
	wire   [2:0] joseproc_data_master_translator_avalon_universal_master_0_burstcount;           // JoseProc_data_master_translator:uav_burstcount -> JoseProc_data_master_agent:av_burstcount
	wire         rsp_mux_src_valid;                                                              // rsp_mux:src_valid -> JoseProc_data_master_agent:rp_valid
	wire  [91:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> JoseProc_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                              // JoseProc_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire  [10:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> JoseProc_data_master_agent:rp_channel
	wire         rsp_mux_src_startofpacket;                                                      // rsp_mux:src_startofpacket -> JoseProc_data_master_agent:rp_startofpacket
	wire         rsp_mux_src_endofpacket;                                                        // rsp_mux:src_endofpacket -> JoseProc_data_master_agent:rp_endofpacket
	wire         joseproc_instruction_master_translator_avalon_universal_master_0_waitrequest;   // JoseProc_instruction_master_agent:av_waitrequest -> JoseProc_instruction_master_translator:uav_waitrequest
	wire  [31:0] joseproc_instruction_master_translator_avalon_universal_master_0_readdata;      // JoseProc_instruction_master_agent:av_readdata -> JoseProc_instruction_master_translator:uav_readdata
	wire         joseproc_instruction_master_translator_avalon_universal_master_0_debugaccess;   // JoseProc_instruction_master_translator:uav_debugaccess -> JoseProc_instruction_master_agent:av_debugaccess
	wire  [13:0] joseproc_instruction_master_translator_avalon_universal_master_0_address;       // JoseProc_instruction_master_translator:uav_address -> JoseProc_instruction_master_agent:av_address
	wire         joseproc_instruction_master_translator_avalon_universal_master_0_read;          // JoseProc_instruction_master_translator:uav_read -> JoseProc_instruction_master_agent:av_read
	wire   [3:0] joseproc_instruction_master_translator_avalon_universal_master_0_byteenable;    // JoseProc_instruction_master_translator:uav_byteenable -> JoseProc_instruction_master_agent:av_byteenable
	wire         joseproc_instruction_master_translator_avalon_universal_master_0_readdatavalid; // JoseProc_instruction_master_agent:av_readdatavalid -> JoseProc_instruction_master_translator:uav_readdatavalid
	wire         joseproc_instruction_master_translator_avalon_universal_master_0_lock;          // JoseProc_instruction_master_translator:uav_lock -> JoseProc_instruction_master_agent:av_lock
	wire         joseproc_instruction_master_translator_avalon_universal_master_0_write;         // JoseProc_instruction_master_translator:uav_write -> JoseProc_instruction_master_agent:av_write
	wire  [31:0] joseproc_instruction_master_translator_avalon_universal_master_0_writedata;     // JoseProc_instruction_master_translator:uav_writedata -> JoseProc_instruction_master_agent:av_writedata
	wire   [2:0] joseproc_instruction_master_translator_avalon_universal_master_0_burstcount;    // JoseProc_instruction_master_translator:uav_burstcount -> JoseProc_instruction_master_agent:av_burstcount
	wire         rsp_mux_001_src_valid;                                                          // rsp_mux_001:src_valid -> JoseProc_instruction_master_agent:rp_valid
	wire  [91:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> JoseProc_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                          // JoseProc_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire  [10:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> JoseProc_instruction_master_agent:rp_channel
	wire         rsp_mux_001_src_startofpacket;                                                  // rsp_mux_001:src_startofpacket -> JoseProc_instruction_master_agent:rp_startofpacket
	wire         rsp_mux_001_src_endofpacket;                                                    // rsp_mux_001:src_endofpacket -> JoseProc_instruction_master_agent:rp_endofpacket
	...
	wire  [31:0] joseproc_jtag_debug_module_agent_m0_readdata;                                   // JoseProc_jtag_debug_module_translator:uav_readdata -> JoseProc_jtag_debug_module_agent:m0_readdata
	wire         joseproc_jtag_debug_module_agent_m0_waitrequest;                                // JoseProc_jtag_debug_module_translator:uav_waitrequest -> JoseProc_jtag_debug_module_agent:m0_waitrequest
	wire         joseproc_jtag_debug_module_agent_m0_debugaccess;                                // JoseProc_jtag_debug_module_agent:m0_debugaccess -> JoseProc_jtag_debug_module_translator:uav_debugaccess
	wire  [13:0] joseproc_jtag_debug_module_agent_m0_address;                                    // JoseProc_jtag_debug_module_agent:m0_address -> JoseProc_jtag_debug_module_translator:uav_address
	wire   [3:0] joseproc_jtag_debug_module_agent_m0_byteenable;                                 // JoseProc_jtag_debug_module_agent:m0_byteenable -> JoseProc_jtag_debug_module_translator:uav_byteenable
	wire         joseproc_jtag_debug_module_agent_m0_read;                                       // JoseProc_jtag_debug_module_agent:m0_read -> JoseProc_jtag_debug_module_translator:uav_read
	wire         joseproc_jtag_debug_module_agent_m0_readdatavalid;                              // JoseProc_jtag_debug_module_translator:uav_readdatavalid -> JoseProc_jtag_debug_module_agent:m0_readdatavalid
	wire         joseproc_jtag_debug_module_agent_m0_lock;                                       // JoseProc_jtag_debug_module_agent:m0_lock -> JoseProc_jtag_debug_module_translator:uav_lock
	wire  [31:0] joseproc_jtag_debug_module_agent_m0_writedata;                                  // JoseProc_jtag_debug_module_agent:m0_writedata -> JoseProc_jtag_debug_module_translator:uav_writedata
	wire         joseproc_jtag_debug_module_agent_m0_write;                                      // JoseProc_jtag_debug_module_agent:m0_write -> JoseProc_jtag_debug_module_translator:uav_write
	wire   [2:0] joseproc_jtag_debug_module_agent_m0_burstcount;                                 // JoseProc_jtag_debug_module_agent:m0_burstcount -> JoseProc_jtag_debug_module_translator:uav_burstcount
	wire         joseproc_jtag_debug_module_agent_rf_source_valid;                               // JoseProc_jtag_debug_module_agent:rf_source_valid -> JoseProc_jtag_debug_module_agent_rsp_fifo:in_valid
	wire  [92:0] joseproc_jtag_debug_module_agent_rf_source_data;                                // JoseProc_jtag_debug_module_agent:rf_source_data -> JoseProc_jtag_debug_module_agent_rsp_fifo:in_data
	wire         joseproc_jtag_debug_module_agent_rf_source_ready;                               // JoseProc_jtag_debug_module_agent_rsp_fifo:in_ready -> JoseProc_jtag_debug_module_agent:rf_source_ready
	wire         joseproc_jtag_debug_module_agent_rf_source_startofpacket;                       // JoseProc_jtag_debug_module_agent:rf_source_startofpacket -> JoseProc_jtag_debug_module_agent_rsp_fifo:in_startofpacket
	wire         joseproc_jtag_debug_module_agent_rf_source_endofpacket;                         // JoseProc_jtag_debug_module_agent:rf_source_endofpacket -> JoseProc_jtag_debug_module_agent_rsp_fifo:in_endofpacket
	wire         joseproc_jtag_debug_module_agent_rsp_fifo_out_valid;                            // JoseProc_jtag_debug_module_agent_rsp_fifo:out_valid -> JoseProc_jtag_debug_module_agent:rf_sink_valid
	wire  [92:0] joseproc_jtag_debug_module_agent_rsp_fifo_out_data;                             // JoseProc_jtag_debug_module_agent_rsp_fifo:out_data -> JoseProc_jtag_debug_module_agent:rf_sink_data
	wire         joseproc_jtag_debug_module_agent_rsp_fifo_out_ready;                            // JoseProc_jtag_debug_module_agent:rf_sink_ready -> JoseProc_jtag_debug_module_agent_rsp_fifo:out_ready
	wire         joseproc_jtag_debug_module_agent_rsp_fifo_out_startofpacket;                    // JoseProc_jtag_debug_module_agent_rsp_fifo:out_startofpacket -> JoseProc_jtag_debug_module_agent:rf_sink_startofpacket
	wire         joseproc_jtag_debug_module_agent_rsp_fifo_out_endofpacket;                      // JoseProc_jtag_debug_module_agent_rsp_fifo:out_endofpacket -> JoseProc_jtag_debug_module_agent:rf_sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                          // cmd_mux_001:src_valid -> JoseProc_jtag_debug_module_agent:cp_valid
	wire  [91:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> JoseProc_jtag_debug_module_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                          // JoseProc_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire  [10:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> JoseProc_jtag_debug_module_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                  // cmd_mux_001:src_startofpacket -> JoseProc_jtag_debug_module_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                    // cmd_mux_001:src_endofpacket -> JoseProc_jtag_debug_module_agent:cp_endofpacket
	...
	wire  [13:0] hex_0_s1_agent_m0_address;                                                      // hex_0_s1_agent:m0_address -> hex_0_s1_translator:uav_address
	...
	wire  [92:0] hex_0_s1_agent_rf_source_data;                                                  // hex_0_s1_agent:rf_source_data -> hex_0_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_0_s1_agent_rsp_fifo_out_data;                                               // hex_0_s1_agent_rsp_fifo:out_data -> hex_0_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> hex_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                          // hex_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire  [10:0] cmd_mux_003_src_channel;                                                        // cmd_mux_003:src_channel -> hex_0_s1_agent:cp_channel
	...
	wire  [13:0] hex_1_s1_agent_m0_address;                                                      // hex_1_s1_agent:m0_address -> hex_1_s1_translator:uav_address
	...
	wire  [92:0] hex_1_s1_agent_rf_source_data;                                                  // hex_1_s1_agent:rf_source_data -> hex_1_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_1_s1_agent_rsp_fifo_out_data;                                               // hex_1_s1_agent_rsp_fifo:out_data -> hex_1_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> hex_1_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                          // hex_1_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [10:0] cmd_mux_004_src_channel;                                                        // cmd_mux_004:src_channel -> hex_1_s1_agent:cp_channel
	...
	wire  [13:0] hex_2_s1_agent_m0_address;                                                      // hex_2_s1_agent:m0_address -> hex_2_s1_translator:uav_address
	...
	wire  [92:0] hex_2_s1_agent_rf_source_data;                                                  // hex_2_s1_agent:rf_source_data -> hex_2_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_2_s1_agent_rsp_fifo_out_data;                                               // hex_2_s1_agent_rsp_fifo:out_data -> hex_2_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_005_src_data;                                                           // cmd_mux_005:src_data -> hex_2_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                          // hex_2_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [10:0] cmd_mux_005_src_channel;                                                        // cmd_mux_005:src_channel -> hex_2_s1_agent:cp_channel
	...
	wire  [13:0] hex_3_s1_agent_m0_address;                                                      // hex_3_s1_agent:m0_address -> hex_3_s1_translator:uav_address
	...
	wire  [92:0] hex_3_s1_agent_rf_source_data;                                                  // hex_3_s1_agent:rf_source_data -> hex_3_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_3_s1_agent_rsp_fifo_out_data;                                               // hex_3_s1_agent_rsp_fifo:out_data -> hex_3_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_006_src_data;                                                           // cmd_mux_006:src_data -> hex_3_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                          // hex_3_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [10:0] cmd_mux_006_src_channel;                                                        // cmd_mux_006:src_channel -> hex_3_s1_agent:cp_channel
	...
	wire  [13:0] hex_4_s1_agent_m0_address;                                                      // hex_4_s1_agent:m0_address -> hex_4_s1_translator:uav_address
	...
	wire  [92:0] hex_4_s1_agent_rf_source_data;                                                  // hex_4_s1_agent:rf_source_data -> hex_4_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_4_s1_agent_rsp_fifo_out_data;                                               // hex_4_s1_agent_rsp_fifo:out_data -> hex_4_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_007_src_data;                                                           // cmd_mux_007:src_data -> hex_4_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                          // hex_4_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [10:0] cmd_mux_007_src_channel;                                                        // cmd_mux_007:src_channel -> hex_4_s1_agent:cp_channel
	...
	wire  [13:0] hex_5_s1_agent_m0_address;                                                      // hex_5_s1_agent:m0_address -> hex_5_s1_translator:uav_address
	...
	wire  [92:0] hex_5_s1_agent_rf_source_data;                                                  // hex_5_s1_agent:rf_source_data -> hex_5_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_5_s1_agent_rsp_fifo_out_data;                                               // hex_5_s1_agent_rsp_fifo:out_data -> hex_5_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_008_src_data;                                                           // cmd_mux_008:src_data -> hex_5_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                          // hex_5_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [10:0] cmd_mux_008_src_channel;                                                        // cmd_mux_008:src_channel -> hex_5_s1_agent:cp_channel
	...
	wire  [13:0] hex_6_s1_agent_m0_address;                                                      // hex_6_s1_agent:m0_address -> hex_6_s1_translator:uav_address
	...
	wire  [92:0] hex_6_s1_agent_rf_source_data;                                                  // hex_6_s1_agent:rf_source_data -> hex_6_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_6_s1_agent_rsp_fifo_out_data;                                               // hex_6_s1_agent_rsp_fifo:out_data -> hex_6_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_009_src_data;                                                           // cmd_mux_009:src_data -> hex_6_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                          // hex_6_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [10:0] cmd_mux_009_src_channel;                                                        // cmd_mux_009:src_channel -> hex_6_s1_agent:cp_channel
	...
	wire  [13:0] hex_7_s1_agent_m0_address;                                                      // hex_7_s1_agent:m0_address -> hex_7_s1_translator:uav_address
	...
	wire  [92:0] hex_7_s1_agent_rf_source_data;                                                  // hex_7_s1_agent:rf_source_data -> hex_7_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] hex_7_s1_agent_rsp_fifo_out_data;                                               // hex_7_s1_agent_rsp_fifo:out_data -> hex_7_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_010_src_data;                                                           // cmd_mux_010:src_data -> hex_7_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                          // hex_7_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                                        // cmd_mux_010:src_channel -> hex_7_s1_agent:cp_channel
	...
	wire         joseproc_data_master_agent_cp_valid;                                            // JoseProc_data_master_agent:cp_valid -> router:sink_valid
	wire  [91:0] joseproc_data_master_agent_cp_data;                                             // JoseProc_data_master_agent:cp_data -> router:sink_data
	wire         joseproc_data_master_agent_cp_ready;                                            // router:sink_ready -> JoseProc_data_master_agent:cp_ready
	wire         joseproc_data_master_agent_cp_startofpacket;                                    // JoseProc_data_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire         joseproc_data_master_agent_cp_endofpacket;                                      // JoseProc_data_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire         joseproc_instruction_master_agent_cp_valid;                                     // JoseProc_instruction_master_agent:cp_valid -> router_001:sink_valid
	wire  [91:0] joseproc_instruction_master_agent_cp_data;                                      // JoseProc_instruction_master_agent:cp_data -> router_001:sink_data
	wire         joseproc_instruction_master_agent_cp_ready;                                     // router_001:sink_ready -> JoseProc_instruction_master_agent:cp_ready
	wire         joseproc_instruction_master_agent_cp_startofpacket;                             // JoseProc_instruction_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire         joseproc_instruction_master_agent_cp_endofpacket;                               // JoseProc_instruction_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire         joseproc_jtag_debug_module_agent_rp_valid;                                      // JoseProc_jtag_debug_module_agent:rp_valid -> router_003:sink_valid
	wire  [91:0] joseproc_jtag_debug_module_agent_rp_data;                                       // JoseProc_jtag_debug_module_agent:rp_data -> router_003:sink_data
	wire         joseproc_jtag_debug_module_agent_rp_ready;                                      // router_003:sink_ready -> JoseProc_jtag_debug_module_agent:rp_ready
	wire         joseproc_jtag_debug_module_agent_rp_startofpacket;                              // JoseProc_jtag_debug_module_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         joseproc_jtag_debug_module_agent_rp_endofpacket;                                // JoseProc_jtag_debug_module_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [91:0] hex_0_s1_agent_rp_data;                                                         // hex_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [91:0] hex_1_s1_agent_rp_data;                                                         // hex_1_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [91:0] hex_2_s1_agent_rp_data;                                                         // hex_2_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [91:0] hex_3_s1_agent_rp_data;                                                         // hex_3_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [91:0] hex_4_s1_agent_rp_data;                                                         // hex_4_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [91:0] hex_5_s1_agent_rp_data;                                                         // hex_5_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [91:0] hex_6_s1_agent_rp_data;                                                         // hex_6_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [91:0] hex_7_s1_agent_rp_data;                                                         // hex_7_s1_agent:rp_data -> router_012:sink_data
	...
	wire         joseproc_jtag_debug_module_agent_rdata_fifo_src_valid;                          // JoseProc_jtag_debug_module_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] joseproc_jtag_debug_module_agent_rdata_fifo_src_data;                           // JoseProc_jtag_debug_module_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         joseproc_jtag_debug_module_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_001:in_0_ready -> JoseProc_jtag_debug_module_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                              // avalon_st_adapter_001:out_0_valid -> JoseProc_jtag_debug_module_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                               // avalon_st_adapter_001:out_0_data -> JoseProc_jtag_debug_module_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                              // JoseProc_jtag_debug_module_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                              // avalon_st_adapter_001:out_0_error -> JoseProc_jtag_debug_module_agent:rdata_fifo_sink_error
	...
	) joseproc_data_master_translator (
		.clk                    (clk_0_clk_clk),                                                           //                       clk.clk
		.reset                  (JoseProc_reset_n_reset_bridge_in_reset_reset),                            //                     reset.reset
		.uav_address            (joseproc_data_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (joseproc_data_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (joseproc_data_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (joseproc_data_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (joseproc_data_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (joseproc_data_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (joseproc_data_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (joseproc_data_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (joseproc_data_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (joseproc_data_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (joseproc_data_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (JoseProc_data_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (JoseProc_data_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (JoseProc_data_master_byteenable),                                         //                          .byteenable
		.av_read                (JoseProc_data_master_read),                                               //                          .read
		.av_readdata            (JoseProc_data_master_readdata),                                           //                          .readdata
		.av_write               (JoseProc_data_master_write),                                              //                          .write
		.av_writedata           (JoseProc_data_master_writedata),                                          //                          .writedata
		.av_debugaccess         (JoseProc_data_master_debugaccess),                                        //                          .debugaccess
	...
	) joseproc_instruction_master_translator (
		.clk                    (clk_0_clk_clk),                                                                  //                       clk.clk
		.reset                  (JoseProc_reset_n_reset_bridge_in_reset_reset),                                   //                     reset.reset
		.uav_address            (joseproc_instruction_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (joseproc_instruction_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (joseproc_instruction_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (joseproc_instruction_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (joseproc_instruction_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (joseproc_instruction_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (joseproc_instruction_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (joseproc_instruction_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (joseproc_instruction_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (joseproc_instruction_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (joseproc_instruction_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (JoseProc_instruction_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (JoseProc_instruction_master_waitrequest),                                        //                          .waitrequest
		.av_read                (JoseProc_instruction_master_read),                                               //                          .read
		.av_readdata            (JoseProc_instruction_master_readdata),                                           //                          .readdata
		.av_burstcount          (1'b1),                                                                           //               (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) joseproc_jtag_debug_module_translator (
		.clk                    (clk_0_clk_clk),                                     //                      clk.clk
		.reset                  (JoseProc_reset_n_reset_bridge_in_reset_reset),      //                    reset.reset
		.uav_address            (joseproc_jtag_debug_module_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (joseproc_jtag_debug_module_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (joseproc_jtag_debug_module_agent_m0_read),          //                         .read
		.uav_write              (joseproc_jtag_debug_module_agent_m0_write),         //                         .write
		.uav_waitrequest        (joseproc_jtag_debug_module_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (joseproc_jtag_debug_module_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (joseproc_jtag_debug_module_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (joseproc_jtag_debug_module_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (joseproc_jtag_debug_module_agent_m0_writedata),     //                         .writedata
		.uav_lock               (joseproc_jtag_debug_module_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (joseproc_jtag_debug_module_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (JoseProc_jtag_debug_module_address),                //      avalon_anti_slave_0.address
		.av_write               (JoseProc_jtag_debug_module_write),                  //                         .write
		.av_read                (JoseProc_jtag_debug_module_read),                   //                         .read
		.av_readdata            (JoseProc_jtag_debug_module_readdata),               //                         .readdata
		.av_writedata           (JoseProc_jtag_debug_module_writedata),              //                         .writedata
		.av_byteenable          (JoseProc_jtag_debug_module_byteenable),             //                         .byteenable
		.av_waitrequest         (JoseProc_jtag_debug_module_waitrequest),            //                         .waitrequest
		.av_debugaccess         (JoseProc_jtag_debug_module_debugaccess),            //                         .debugaccess
		.av_begintransfer       (),                                                  //              (terminated)
		.av_beginbursttransfer  (),                                                  //              (terminated)
		.av_burstcount          (),                                                  //              (terminated)
		.av_readdatavalid       (1'b0),                                              //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) joseproc_data_master_agent (
		.clk                   (clk_0_clk_clk),                                                           //       clk.clk
		.reset                 (JoseProc_reset_n_reset_bridge_in_reset_reset),                            // clk_reset.reset
		.av_address            (joseproc_data_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (joseproc_data_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (joseproc_data_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (joseproc_data_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (joseproc_data_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (joseproc_data_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (joseproc_data_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (joseproc_data_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (joseproc_data_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (joseproc_data_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (joseproc_data_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (joseproc_data_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (joseproc_data_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (joseproc_data_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (joseproc_data_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (joseproc_data_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) joseproc_instruction_master_agent (
		.clk                   (clk_0_clk_clk),                                                                  //       clk.clk
		.reset                 (JoseProc_reset_n_reset_bridge_in_reset_reset),                                   // clk_reset.reset
		.av_address            (joseproc_instruction_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (joseproc_instruction_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (joseproc_instruction_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (joseproc_instruction_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (joseproc_instruction_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (joseproc_instruction_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (joseproc_instruction_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (joseproc_instruction_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (joseproc_instruction_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (joseproc_instruction_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (joseproc_instruction_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (joseproc_instruction_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (joseproc_instruction_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (joseproc_instruction_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (joseproc_instruction_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (joseproc_instruction_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) joseproc_jtag_debug_module_agent (
		.clk                     (clk_0_clk_clk),                                               //             clk.clk
		.reset                   (JoseProc_reset_n_reset_bridge_in_reset_reset),                //       clk_reset.reset
		.m0_address              (joseproc_jtag_debug_module_agent_m0_address),                 //              m0.address
		.m0_burstcount           (joseproc_jtag_debug_module_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (joseproc_jtag_debug_module_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (joseproc_jtag_debug_module_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (joseproc_jtag_debug_module_agent_m0_lock),                    //                .lock
		.m0_readdata             (joseproc_jtag_debug_module_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (joseproc_jtag_debug_module_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (joseproc_jtag_debug_module_agent_m0_read),                    //                .read
		.m0_waitrequest          (joseproc_jtag_debug_module_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (joseproc_jtag_debug_module_agent_m0_writedata),               //                .writedata
		.m0_write                (joseproc_jtag_debug_module_agent_m0_write),                   //                .write
		.rp_endofpacket          (joseproc_jtag_debug_module_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (joseproc_jtag_debug_module_agent_rp_ready),                   //                .ready
		.rp_valid                (joseproc_jtag_debug_module_agent_rp_valid),                   //                .valid
		.rp_data                 (joseproc_jtag_debug_module_agent_rp_data),                    //                .data
		.rp_startofpacket        (joseproc_jtag_debug_module_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (joseproc_jtag_debug_module_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (joseproc_jtag_debug_module_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (joseproc_jtag_debug_module_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (joseproc_jtag_debug_module_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (joseproc_jtag_debug_module_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (joseproc_jtag_debug_module_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (joseproc_jtag_debug_module_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (joseproc_jtag_debug_module_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (joseproc_jtag_debug_module_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (joseproc_jtag_debug_module_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (joseproc_jtag_debug_module_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (joseproc_jtag_debug_module_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (joseproc_jtag_debug_module_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) joseproc_jtag_debug_module_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                               //       clk.clk
		.reset             (JoseProc_reset_n_reset_bridge_in_reset_reset),                // clk_reset.reset
		.in_data           (joseproc_jtag_debug_module_agent_rf_source_data),             //        in.data
		.in_valid          (joseproc_jtag_debug_module_agent_rf_source_valid),            //          .valid
		.in_ready          (joseproc_jtag_debug_module_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (joseproc_jtag_debug_module_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (joseproc_jtag_debug_module_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (joseproc_jtag_debug_module_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (joseproc_jtag_debug_module_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (joseproc_jtag_debug_module_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (joseproc_jtag_debug_module_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (joseproc_jtag_debug_module_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                       // (terminated)
		.csr_read          (1'b0),                                                        // (terminated)
		.csr_write         (1'b0),                                                        // (terminated)
		.csr_readdata      (),                                                            // (terminated)
	...
	joseproc_mm_interconnect_0_router router (
		.sink_ready         (joseproc_data_master_agent_cp_ready),          //      sink.ready
		.sink_valid         (joseproc_data_master_agent_cp_valid),          //          .valid
		.sink_data          (joseproc_data_master_agent_cp_data),           //          .data
		.sink_startofpacket (joseproc_data_master_agent_cp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (joseproc_data_master_agent_cp_endofpacket),    //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_router_001 router_001 (
		.sink_ready         (joseproc_instruction_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (joseproc_instruction_master_agent_cp_valid),         //          .valid
		.sink_data          (joseproc_instruction_master_agent_cp_data),          //          .data
		.sink_startofpacket (joseproc_instruction_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (joseproc_instruction_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	joseproc_mm_interconnect_0_router_002 router_002 (
	...
	joseproc_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (joseproc_jtag_debug_module_agent_rp_ready),         //      sink.ready
		.sink_valid         (joseproc_jtag_debug_module_agent_rp_valid),         //          .valid
		.sink_data          (joseproc_jtag_debug_module_agent_rp_data),          //          .data
		.sink_startofpacket (joseproc_jtag_debug_module_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (joseproc_jtag_debug_module_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	joseproc_mm_interconnect_0_router_003 router_004 (
	...
	joseproc_mm_interconnect_0_router_002 router_005 (
	...
	joseproc_mm_interconnect_0_router_002 router_006 (
	...
	joseproc_mm_interconnect_0_router_002 router_007 (
	...
	joseproc_mm_interconnect_0_router_002 router_008 (
	...
	joseproc_mm_interconnect_0_router_002 router_009 (
	...
	joseproc_mm_interconnect_0_router_002 router_010 (
	...
	joseproc_mm_interconnect_0_router_002 router_011 (
	...
	joseproc_mm_interconnect_0_router_002 router_012 (
	...
	joseproc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_mux cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                  (clk_0_clk_clk),                                //       clk.clk
		.reset                (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (JoseProc_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	joseproc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (JoseProc_reset_n_reset_bridge_in_reset_reset),             // in_rst_0.reset
	...
	joseproc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (JoseProc_reset_n_reset_bridge_in_reset_reset),          // in_rst_0.reset
		.in_0_data      (joseproc_jtag_debug_module_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (joseproc_jtag_debug_module_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (joseproc_jtag_debug_module_agent_rdata_fifo_src_ready), //         .ready
